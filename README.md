...
Programda her ders için sınav zamanı ve sınav süresi dikkate alınarak bir ders yükü hesaplanmaktadır. Ayrıca öğretim üyelerinin kıdem bilgileri de hesaba katılarak toplam iş yükünün adil biçimde paylaşılması hedeflenmektedir. <br>
...
Ders ataması sırasında öğretim üyesinin mevcut toplam yükü ve kıdem katsayısı birlikte değerlendirilerek karar verilmektedir. Böylece belirli bir öğretim üyesinin aşırı yük altında kalması engellenmektedir. <br>
